              ...
              <div className='flex items-center justify-center h-full animate-fadeIn'>
                <div className='text-center max-w-xl'>
                  <div className='w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-lg animate-breathing animate-warm-glow'>
                    <svg
                      className='w-6 h-6 text-white animate-gentle-pulse'
                      fill='none'
                      stroke='currentColor'
                      viewBox='0 0 24 24'
                    >
                  ...
                  <p className='text-gray-600 dark:text-gray-300 mb-3 text-sm'>
                    Get personalized guidance, expert advice, and actionable
                    insights to accelerate your professional journey!
                  </p>
                  <div className='grid grid-cols-2 md:grid-cols-4 gap-2 text-left'>
                    <div
                      className='bg-white dark:bg-gray-900 p-2 rounded-lg border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-human cursor-pointer hover-lift animate-subtle-float'
