          ...
          <div className='pt-20 pb-16 text-center'>
            <div className='max-w-4xl mx-auto'>
              ...
              <p className='text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed'>
                Get personalized career guidance, skill development
                recommendations, and interview preparation from our advanced AI
                mentor. Accelerate your professional growth with intelligent
                insights.
              </p>
              ...
              <div className='flex flex-col sm:flex-row justify-center gap-4 mb-16'>
                <button
                  onClick={handleAnonymousChat}
                  className='px-6 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 transition-colors cursor-pointer'
                >
                  Start Free Session
                </button>
                <button
                  onClick={() => router.push('/login')}
                  className='px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white font-medium rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors cursor-pointer'
                >
                  Create Account
                </button>
              </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                <div className='group'>
                  <div className='p-6 rounded-lg border border-gray-200/50 dark:border-gray-700/50 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm hover:border-blue-300 dark:hover:border-blue-600 transition-all duration-300'>
                    ...
                    <p className='text-gray-600 dark:text-gray-400 text-sm leading-relaxed'>
                      Get personalized career roadmaps based on your goals,
                ...
                <div className='group'>
                  <div className='p-6 rounded-lg border border-gray-200/50 dark:border-gray-700/50 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm hover:border-blue-300 dark:hover:border-blue-600 transition-all duration-300'>
                    ...
                    <p className='text-gray-600 dark:text-gray-400 text-sm leading-relaxed'>
                      Identify skill gaps and get curated learning resources to
                      advance your career
                    </p>
                  </div>
                </div>
